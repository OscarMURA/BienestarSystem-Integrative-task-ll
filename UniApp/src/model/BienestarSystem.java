...
public class BienestarSystem {
    ...
    public String histogramGenerator() {
        ...
        int i = 0;
        String[] categories = {"low weight", "normal", "overweight", "obesity", "morbid obesity"};
        String[] title = {"Histogram_of_the_BMI_of_students_in_September_2022", "Histogram_of_the_BMI_of_students_in_April_2023"};
        do {
    ...
    public String statesListReports(int option) {
        ...
        String[] title = {"List_of_the_BMI_of_students_in_September_2022", "List_of_the_BMI_of_students_in_April_2023"};
        String[] categories = {"low weight", "normal", "overweight", "obesity", "morbid obesity"};

        if (option == 1) {
            comparator = (student1, student2) -> Double.compare(student1.getNutritionalStates().get(0).getBMI(), student2.getNutritionalStates().get(0).getBMI());
            comparator2 = (student1, student2) -> Double.compare(student1.getNutritionalStates().get(1).getBMI(), student2.getNutritionalStates().get(1).getBMI());
        } else if (option == 2)
        ...
        do {
            ...
            ArrayList<Object> values = new ArrayList<>(Arrays.asList(lowWeight, normalWeight, overweight, obesity, morbidObesity));
    ...
    public String indicatorChangesNutritionalStates() {
        ...
        for (Student student : students) {
            ...
            if (type.equals(TypeStates.LOW_WEIGHT) && type2.equals(TypeStates.NORMAL_WEIGHT))
                ...
                overweightToNormal++;
            else if (type.equals(TypeStates.OBESITY) && (type2.equals(TypeStates.NORMAL_WEIGHT) || type2.equals(TypeStates.OVERWEIGHT)))
                obesityToNormal++;
            else if (type.equals(TypeStates.MORBID_OBESITY) && (type2.equals(TypeStates.NORMAL_WEIGHT) || type2.equals(TypeStates.OVERWEIGHT)))
                morbidObesityToNormal++;
            else if (type.equals(TypeStates.NORMAL_WEIGHT) && type2.equals(TypeStates.LOW_WEIGHT))
                normalToLow++;
            else if (type.equals(TypeStates.NORMAL_WEIGHT) && (type2.equals(TypeStates.OVERWEIGHT) || (type2.equals(TypeStates.OBESITY)) ))
                normalToOverwieght++;
            else if (type.equals(TypeStates.OVERWEIGHT) && ((type2.equals(TypeStates.OBESITY)) || type2.equals(TypeStates.MORBID_OBESITY)))
                overweightToMore++;
            else if (type.equals(TypeStates.OBESITY) && type2.equals(TypeStates.MORBID_OBESITY))
                obesityToMorbid++;

        }
        allChange = lowToNormal + overweightToNormal + obesityToNormal + morbidObesityToNormal + normalToLow + normalToOverwieght + overweightToMore + obesityToMorbid;
        ...
        ArrayList<Object> values =
                new ArrayList<>(Arrays.asList(lowToNormal, overweightToNormal, obesityToNormal, morbidObesityToNormal, normalToLow, normalToOverwieght, overweightToMore, obesityToMorbid));
    ...
    public String indicatorListChangeNutritionalStates(int option) {
        ...
        int allChange = 0, plus = 0, less = 0;
        if (option == 1) {
            comparator = (student1, student2) -> Double.compare(student1.getNutritionalStates().get(1).getBMI(), student2.getNutritionalStates().get(1).getBMI());
        } else if (option == 2)
