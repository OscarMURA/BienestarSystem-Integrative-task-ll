...
public class ReportsTest {
    ...
    public void setstestOfTheClassReports() {
        ...
        String newCategory[] = { "new low weight", "new normal", "new overweight", "new obesity",
                "new morbid obesity" };
     ...
     * correctly represented in the instogram.
     * represented in the instogram, and verifies that the histogram is generated
     * correctly.
     ...
     * the study variables are qualitative, so it throws the exception
     * ExceptionFormatOfValueAllowed.
     */
    @Test
     ...
     * the study variables are quantitative, so it throws the exception
     * ExceptionFormatOfValueAllowed.
     */
    @Test
     ...
     * Since in the lists, each category will have a list, so it will be stored in
     * an array,
